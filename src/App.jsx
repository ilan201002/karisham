...
const renderField=()=>(
<div style={{paddingTop:16,paddingBottom:"calc(54px + env(safe-area-inset-bottom))",minHeight:"calc(100dvh - 83px - env(safe-area-inset-top) - 120px - 46px - env(safe-area-inset-bottom))"}}>
...
return(
<div style={{paddingTop:16,paddingBottom:"calc(54px + env(safe-area-inset-bottom))",minHeight:"calc(100dvh - 83px - env(safe-area-inset-top) - 46px - env(safe-area-inset-bottom))"}}>
