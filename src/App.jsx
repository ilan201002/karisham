...
const renderField=()=>(
<div style={{paddingTop:16,paddingBottom:"calc(57px + env(safe-area-inset-bottom))",minHeight:"calc(100dvh - 83px - env(safe-area-inset-top) - 120px - 49px - env(safe-area-inset-bottom))"}}>
...
return(
<div style={{paddingTop:16,paddingBottom:"calc(57px + env(safe-area-inset-bottom))",minHeight:"calc(100dvh - 83px - env(safe-area-inset-top) - 46px - env(safe-area-inset-bottom))"}}>
...
<div style={{position:"fixed",bottom:0,left:0,right:0,height:"calc(49px + env(safe-area-inset-bottom))",paddingBottom:"env(safe-area-inset-bottom)",paddingLeft:"env(safe-area-inset-left)",paddingRight:"env(safe-area-inset-right)",boxSizing:"border-box",background:C.white,boxShadow:"0 -1px 0 rgba(0,0,0,0.08)",display:"flex",alignItems:"stretch",zIndex:100}}>
{TABS.map(t=>{
const act=tab===t.id;
return(
